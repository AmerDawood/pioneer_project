...
/*
make functions for 
   - show news , news by id , add news 
   - show organizations
  - show intiative , add intiative
  - make a screen to join intiative
  - make status screen 
  - github 
  - vedio for show some data 
...
// update profile date 
// internet connection 
// add app name , image for app 
// theme color
// language for some screen 
// make initiatve screen (login , add news , add initiatves , show users for initiatves)
// make a screen to organization details 
